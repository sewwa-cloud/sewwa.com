...
![Context Engineering Overview - Diagram showing how AGENTS.md and agent skills provide context to AI coding agents](./images/context-engineering-overview.png)
...
![Discovery Cost Comparison - Before and after showing repeated file scans vs instant context understanding](./images/discovery-cost.png)
...
![AGENTS.md File Structure - Visual breakdown of AGENTS.md sections with example content](./images/agents-md-structure.png)
...
![Agent Skills Concept - Modular skill files loaded on-demand for specific workflows](./images/agent-skills-concept.png)
...
![Agent Reading AGENTS.md - Sequence showing agent discovering and reading AGENTS.md at session start](./images/agent-reading-agents-md.png)
...
![AGENTS.md Size Optimization - Graph showing optimal AGENTS.md size vs context window usage](./images/agents-md-size.png)
...
![Agent Skill Loading - Sequence showing skill loading on-demand during authentication task](./images/skill-loading-sequence.png)
...
![Performance Comparison - Three-column comparison showing no context vs AGENTS.md vs AGENTS.md + skill](./images/performance-comparison.png)
...
![Decision Tree - Flowchart showing when to use AGENTS.md vs agent skills](./images/decision-tree.png)
...
![Success Metrics - Dashboard showing token reduction, mistake rate, and time savings](./images/success-metrics.png)
...
![Future Vision - Timeline showing evolution from manual coding to AI-assisted to context-aware development](./images/future-vision.png)
